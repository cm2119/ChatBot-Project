...
print("Hallo! Pleased to meet you," + name)
...
def myAge(age1):
  if age1 < 15:
    ...
    print("This is the best time to enjoy your teenage years! How can I help you today?")
  elif age1 >= 18 and age1 < 55:
    print("Oh to be " + str(age) + " must be interesting. How can I help you today?")
